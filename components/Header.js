...
function Header({placeholder}) {
    ...
    return (
        ...
        <div className='flex items-center md:border-2 md:shadow-sm rounded-full py-2'>
            ...
            pl-5 text-sm texx-gray-600 placeholder-gray-400'
        ...
        <div className='flex space-x-4 items-center justify-end text-gray-500'>
            <p className=' md:mx-2 cursor-pointer'> Become a host</p>
            ...
            {searchInput && (
                    ...
                    <div className='flex items-center border-b mb-4'>
                        <h2 className='text-2xl flex-grow font-semibold'>Numbers of Guests</h2>
                        ...
                        value={noOfGuest}
                        min={1}
                        className='w-10 pl-2 text-lg text-red-400 outline-none'/>
                    </div>
